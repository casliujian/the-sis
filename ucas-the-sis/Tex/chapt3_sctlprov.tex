...
基本类型包含以下几种：
\begin{itemize}
	\item \code{unit}: \code{unit}类型的值只有一个，即\code{()}。
	\item \code{int}: \code{int}代表整数类型，一个值\
\end{itemize}
