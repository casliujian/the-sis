...
\subsection{案例二：小型飞机场控制协议}
在本小节中，我们介绍对于一个工程问题的形式化验证：由美国国家航空与航天局（National Aeronautics and Space Administration，简称NASA）提出的小型飞机场运输系统（Small Aircraft Transportation System，简称SATS）\cite{MunozDC04,nasasats04}。在\sctlprov{}中，我们对SATS系统进行形式化描述\footnote{\url{https://github.com/terminatorlxj/SATS-model}}，并验证该系统的安全性。
