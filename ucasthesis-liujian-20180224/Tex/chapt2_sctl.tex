...
\couic{In benchmark {\#}2, we increase the number of state variables in benchmark \#1 to $48$, $60$, or $72$ for Concurrent Processes, and $24$,
...
\couic{To show the importance of using continuation-passing style,
	...
	\begin{table}\small
		...
		\begin{center}
			\begin{tabular}{| l | r | r | r |}
				...
				\hline
				\textbf{测试集} & \sctl{} solvable & \sctlprovr{} solvable & t(\sctlprov) $<$ t(\sctlprovr{})  \\
				\hline
				...
				\hline
				\textbf{二} & 2597(90.2\%) & 2306(80.1\%) & 2406(83.5\%)\\
				\hline
				\textbf{三} & 1849(64.2\%) & 1520(52.8\%) & 1735(60.2\%)\\
				\hline
			\end{tabular}
		\end{center}
		\caption{在测试集一、二、三上\sctl{}和\sctlprovr{}的实验数据对比}
...
\couic{This benchmark consists of two sets of concurrent programs: the mutual
...
\couic{The experimental results (Table~\ref{tabl:solvable:mutual:ring} and Table \ref{tabl:compare:mutual:ring}) show that \sctl{} solves more test cases than \verds, \nusmv{}, and \nuxmv{}. At the same time, \sctl{} is more time and space efficiency in more than 75 percent of the test cases than the other three tools.  
